...
```
Ecommerce-Pricescrapper-Automation/
├── clients/
...
```bash
git clone <repo-url> Ecommerce-Pricescrapper-Automation
cd Ecommerce-Pricescrapper-Automation
...
Type=oneshot
User=ubuntu
WorkingDirectory=/home/ubuntu/Ecommerce-Pricescrapper-Automation
ExecStart=/home/ubuntu/Ecommerce-Pricescrapper-Automation/venv/bin/python main.py --limit 20
EnvironmentFile=/home/ubuntu/Ecommerce-Pricescrapper-Automation/.env
